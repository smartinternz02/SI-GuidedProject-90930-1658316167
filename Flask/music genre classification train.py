...
directory = "D:/TSB PROJECTS/MUSIC GENRE/archive/genres/"
f = open("my.dat" ,'wb')
i = 0
...
def loadDataset(filename):
    with open("D:/TSB PROJECTS/MUSIC GENRE/archive/genres/my.dat" , 'rb') as f:
        while True:
            try:
...
loadDataset("D:/TSB PROJECTS/MUSIC GENRE/archive/genres/my.dat")
