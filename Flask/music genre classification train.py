...
directory = "D:/5E1/Music-Genre-Classification/Flask"
f = open("my.dat" ,'wb')
i = 0
...
def loadDataset(filename):
    with open("D:/5E1/Music-Genre-Classification/Flask/my.dat" , 'rb') as f:
        while True:
            try:
...
loadDataset("D:/5E1/Music-Genre-Classification/Flask/my.dat")
